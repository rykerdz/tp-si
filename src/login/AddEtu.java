 ...
 * @author Youcef
 */
public class AddEtu extends javax.swing.JFrame {
    ...
    private void ajouterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ajouterActionPerformed
        int confirmed = JOptionPane.showConfirmDialog(null, "Ajouter Etudiante?","AJOUTER",JOptionPane.YES_NO_OPTION);
        if(confirmed == JOptionPane.YES_OPTION){
            ...
            try {
                ...
                if (rs.next()){
                    ...
                    pst2.setInt(4, group);
                    pst2.setString(5, Integer.toString(codes));

                    int rs2 = pst2.executeUpdate();
                    if (rs2>0){

                        jLabel2.setText("Student added successfully!");
                    }
                    else{
            ...
            con.close();
                ...
                Logger.getLogger(AddEtu.class.getName()).log(Level.SEVERE, null, ex);
    ...
    String mat = jTextField1.getText();
        try {
            ...
            ResultSet rs = pst.executeQuery();
            if (rs.next()){
                jLabel2.setText("A Student with this matricule exists!");
            }
            else{
                ajouter.setEnabled(true);
                jLabel2.setText("Matricule doesnt exists. you add other infos now!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddEtu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
